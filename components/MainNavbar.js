...
export default function MainNavbar({currentPage}) {
  ...
  return (
    <header>
        ...
        {
            currentPage == "Home" && 
            <Hero imgUrl="https://mdbootstrap.com/img/new/slides/041.webp" action="Join Now" head="Welcome to our Developer Club" subHead="Explore the world of coding and collaboration"/>
        }
    </header>
  );
}