import { MDBBtn, MDBCard, MDBCardBody, MDBCardTitle, MDBCardSubTitle, MDBCardText } from 'mdb-react-ui-kit'
  ...
  return (
    <MDBCard className='news-card-style mb-4' key={id}>
        <MDBCardBody>
          ...
          <small className='text-muted text-end d-block mb-md-0 mb-2'>{date}</small>
