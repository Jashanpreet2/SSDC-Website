...
export default function Review() {
  const reviews = [
    ...
    },
    {
      id: 3,
      name: 'Emily Johnson',
      review: 'Helpful and friendly community',
      star: 4,
      imgSrc: 'https://mdbootstrap.com/img/new/slides/041.webp',
    },
    {
      id: 4,
      name: 'Michael Brown',
      review: 'Amazing content and instructors',
      star: 5,
      imgSrc: 'https://mdbootstrap.com/img/new/slides/041.webp',
    },
    {
      id: 5,
      name: 'Sarah Davis',
      review: 'Learned a lot from the courses',
      star: 3,
      imgSrc: 'https://mdbootstrap.com/img/new/slides/041.webp',
    },
    {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Read authentic reviews from our club. We look forward to having you join our club."
        />
      ...
      <h2 className="d-lg-block d-none mt-5 text-center">Member Reviews</h2>
      <div className="mt-5">
